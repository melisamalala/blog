...
Revision ID: b03c2f1be17e
Revises: 
Create Date: 2018-09-13 11:41:02.319287
...
def upgrade():
    ...
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('blogpost', sa.Integer(), nullable=True),
    sa.Column('time', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['blogpost'], ['blogpost.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
